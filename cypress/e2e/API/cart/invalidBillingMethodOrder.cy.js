describe('Create an order with invalid billing address', () => {
    let authToken;
    let cartId;
    ...
    it('should fail to place an order with invalid billing address', () => {
        ...
        cy.request({
            ...
            cy.request({
                ...
                cy.request({
                    ...
                    expect(setBillingAddressResponse.status).to.eq(500); // Esperamos un error 500
                    expect(setBillingAddressResponse.body.errors).to.have.length.greaterThan(0);
                });
            });
        });
    });
